...
@section('content')
    ...
    <section class="grid grid-cols-1 gap-4 xl:grid-cols-[0.9fr_1.1fr]">
        ...
        <x-ui.card title="Request Details">
            <form method="POST" action="{{ route('web.booking.submit') }}" class="grid grid-cols-1 gap-3 sm:grid-cols-2" data-stepper-form>
                @csrf
                <div class="sm:col-span-2 space-y-3" data-step-panel="1">
                    ...
                    <button type="button" class="btn-pill btn-primary" data-step-next>Continue to Details</button>
                </div>

                <div class="sm:col-span-2 grid grid-cols-1 gap-3 sm:grid-cols-2" data-step-panel="2">
                ...
                <div class="sm:col-span-2 space-y-3" data-step-panel="3">
                    <div class="rounded-2xl border border-slate-200 p-4 dark:border-slate-700">
